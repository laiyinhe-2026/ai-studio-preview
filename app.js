const modes = {
  text: {
    ...
    prompt:
      "为淮南传媒 AI 创作平台写一段 30 秒品牌短片脚本，突出文本、图片、视频、音乐音频生成，以及自动上传个人云素材库。",
    controls: [
  ...
  image: {
    ...
    prompt:
      "生成一张淮南传媒 AI 创作工作台的产品海报，画面包含多模态资产卡片、深蓝媒体集团界面、冷白高光，质感精致。",
    controls: [
  ...
  video: {
    ...
    prompt:
      "制作一段 8 秒产品广告视频：镜头穿过淮南传媒 AI 创作工作台，文本、图片、视频、音频资产依次生成并自动汇入云素材库。",
    controls: [
      ["时长", ["8 秒", "12 秒", "20 秒"]],
      ["比例", ["16:9", "9:16", "1:1"]],
      ["运动强度", ["低", "中", "高"]],
  ...
  audio: {
    ...
    prompt:
      "生成一段 20 秒高端媒体科技品牌 BGM，节奏冷静、空间感强，适合淮南传媒 AI 创作平台产品演示视频。",
    controls: [
      ["类型", ["BGM", "歌曲", "配音", "音效"]],
      ["情绪", ["冷静", "振奋", "神秘", "温暖"]],
      ["时长", ["20 秒", "45 秒", "90 秒"]],
...
function buildPresetPrompt(preset) {
  const library = {
    ...
    小红书种草文案: "写一篇面向媒体编辑、设计师和内容团队的小红书种草文案，介绍淮南传媒 AI 全模态创作台的工作流优势。",
    产品发布稿: "写一篇淮南传媒 AI 全模态创作平台的产品发布稿，语气专业，强调模型生态、云素材库和内容生产效率。",
    提示词优化: "优化以下提示词，让它更适合用于生成高端商业视觉资产。",
    电商主图: "生成一张高端产品主图，主体为淮南传媒 AI 创作平台的界面大屏，深蓝背景，真实设备质感。",
    品牌海报: modes.image.prompt,
    人物写真: "生成一张 AI 创作者的专业人物写真，置身未来感创作工作室，真实摄影，高级布光。",
    概念场景: "生成一个淮南传媒未来 AI 内容指挥中心，包含多屏幕、多模态资产流和云端同步视觉。",
    ...
    旁白配音: "生成一段沉稳、可信赖的中文旁白，适合淮南传媒 AI 创作平台产品演示。",
